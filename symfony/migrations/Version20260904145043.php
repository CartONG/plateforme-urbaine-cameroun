 ...
 */
final class Version20260904145043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE divercity.event_activity_type ADD color VARCHAR(7) DEFAULT '#3B82F6' NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE divercity.event_activity_type DROP color
        SQL);
        $this->addSql(<<<'SQL'

 ...
 */
final class Version20260829135911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE divercity.blocked_period ADD recurrence_group_id VARCHAR(36) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE divercity.blocked_period DROP recurrence_group_id
        SQL);
    }
}

...
final class BookingRejectedMailer extends AbstractUserMailer
{
    public function send(Booking $booking): void
    {
        $email = (new TemplatedEmail())
            ->to(new Address($booking->getEmail(), $booking->getFirstName().' '.$booking->getLastName()))
            ->subject($this->translator->trans('mail.divercity.booking_rejected.subject'))
            ->htmlTemplate('mail/divercity/booking_rejected.html.twig')

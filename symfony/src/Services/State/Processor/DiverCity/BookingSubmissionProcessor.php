...
class BookingSubmissionProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): mixed
    {
        ...
        if ($bookingDateTime < $minimumBookingDateTime) {
            throw new UnprocessableEntityHttpException(sprintf('Les réservations doivent être effectuées au moins %dh à l\'avance. Le créneau le plus proche disponible est le %s.', self::MINIMUM_ADVANCE_HOURS, $minimumBookingDateTime->format('d/m/Y à H:i')));
        }
